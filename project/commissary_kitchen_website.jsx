    ...
    <div className="min-h-screen bg-neutral-950 text-white">
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-neutral-300">
            No long-term lease. No buildout. Just show up and get to work. Built for food trucks, bakers, meal prep businesses, and beverage brands that need a clean, reliable place to produce.
          </p>

          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <a href="#tour" className="rounded-xl bg-amber-300 px-6 py-3 font-medium text-black transition hover:bg-amber-200">
              Book a Tour
            </a>
            <a href="#pricing" className="rounded-xl border border-white/20 px-6 py-3 text-white transition hover:bg-white/10">
              View Pricing
            </a>
          </div>
      ...
      <section id="pricing" className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-neutral-300">Everything you need to operate—without the cost of building your own kitchen.</p>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl border border-white/10 p-6">
              ...
              <p className="mt-2 text-neutral-300">Starting under $599 · Hourly, daily, weekly, monthly</p>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-neutral-900 p-8">
          <div className="grid gap-8 lg:grid-cols-[0.95fr,1.05fr] lg:items-start">
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <select name="preferred_schedule" defaultValue="" className="rounded-xl bg-white/10 px-4 py-3 text-white">
                ...
                <select name="storage_needs" defaultValue="" className="rounded-xl bg-white/10 px-4 py-3 text-white">
                  <option value="" disabled>
